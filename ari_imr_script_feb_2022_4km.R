...
TC_4km <- read.csv("treat_control_4km.csv") #csv is in the drive

#takes data from all rows w/2014 as a data value under year by View(TC_4km)
#706 total = 888 control and 76 treated
TC_4km_2014sub <- subset(TC_4km, year == "2014")

#creates a matrix with 706 rows, 1 col, filled w/NA
#number of rows = length of data = number of villages
numVillages <- 706
count <- matrix(NA,numVillages,1)
#labels each row from 1 to 706
count[,1] <- c(1:numVillages)

#assigns each row in the data set of the 2014 subset with a unqiue identifies (1-706)
TC_4km_2014sub_count <- cbind(count,TC_4km_2014sub)

#deletes everything except the longitude and latitude values from the data set (from columns 4 and 5)
#needs to be long, lat
TC_4km_2014sub_count <- TC_4km_2014sub_count[,c(5,4)]
...
#from the TIF file, extracts the points related to the TC_4km_2014sub_count
#gets infant data related to each village (coordinates for each TC_4km_2014sub_count -- 706 villages)
rast_pr_ghdx_trial_ug <- raster::extract(pr_ghdx_trial_ug, TC_4km_2014sub_count)
...
#matrix that contains imr for years 2000-2017 for each 706 villages in Uganda
...
rast_val_NTL_2003_TC <- raster::extract(pr_NTL_2003, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(TC_4km_2014sub, rast_val_NTL_2003_TC)
...
rast_val_NTL_2004_TC <- raster::extract(pr_NTL_2004, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2004_TC)
...
rast_val_NTL_2005_TC <- raster::extract(pr_NTL_2005, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2005_TC)
...
rast_val_NTL_2006_TC <- raster::extract(pr_NTL_2006, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2006_TC)
...
rast_val_NTL_2007_TC <- raster::extract(pr_NTL_2007, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2007_TC)
...
rast_val_NTL_2008_TC <- raster::extract(pr_NTL_2008, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2008_TC)
...
rast_val_NTL_2009_TC <- raster::extract(pr_NTL_2009, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2009_TC)
...
rast_val_NTL_2010_TC <- raster::extract(pr_NTL_2010, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2010_TC)
...
rast_val_NTL_2011_TC <- raster::extract(pr_NTL_2011, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2011_TC)
...
rast_val_NTL_2012_TC <- raster::extract(pr_NTL_2012, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2012_TC)
...
rast_val_NTL_2013_TC <- raster::extract(pr_NTL_2013, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2013_TC)
...
rast_val_NTL_2014_TC <- raster::extract(pr_NTL_2014, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2014_TC)
...
rast_val_NTL_2015_TC <- raster::extract(pr_NTL_2015, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2015_TC)
...
rast_val_NTL_2016_TC <- raster::extract(pr_NTL_2016, TC_4km_2014sub_count)
...
raster_TC_4km_2014sub <- cbind(raster_TC_4km_2014sub, rast_val_NTL_2016_TC)


#write.csv(raster_TC_4km_2014sub, "raster_TC_4km_2014sub.csv")


raster_TC_4km_2014sub_zeros <- raster_TC_4km_2014sub

raster_TC_4km_2014sub_zeros[is.na(raster_TC_4km_2014sub_zeros)] <- 0